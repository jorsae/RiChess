...
@pytest.mark.parametrize("fen, expected_player_turn, expected_halfmove, expected_fullmove", [
    ("8/ppp1k3/8/8/8/8/PP6/RN1K3R w KQ - 0 1", Colour.WHITE, 0, 1),
    ("r1bqkbnr/p1p1pppp/2np4/8/2BP4/4PN2/PP3PPP/RNBQK2R b KQkq - 0 5", Colour.BLACK, 0, 5),
    ("3b4/4kp2/7p/5p2/2r5/1P3N1P/P2R2PK/8 b - - 60 111", Colour.BLACK, 60, 111),
    ("r2qkbnr/p2bppp1/2p4p/4p3/2B5/2N1P3/PP1BQPPP/2R2RK1 b - - 1 12", Colour.BLACK, 1, 12),
    ("1r1qkb1r/p3ppp1/2p1bn1p/8/2B1Pp2/2N1B2P/PP2Q1P1/2R2RK1 w - - 19 25", Colour.WHITE, 19, 25),
])
def test_load_fen(fen, expected_player_turn, expected_halfmove, expected_fullmove):
    fp = FenParser(fen)
    fp.parse()
